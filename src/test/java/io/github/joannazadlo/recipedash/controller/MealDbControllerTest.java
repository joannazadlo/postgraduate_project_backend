...
@WebMvcTest(MealDbController.class)
@ActiveProfiles("test")
@AutoConfigureMockMvc(addFilters = false)
public class MealDbControllerTest {
    ...
    void getRecipeById_ShouldReturnRecipe() throws Exception {
        ...
        when(mealDbService.getRecipeDetailById("1")).thenReturn(recipeDto);

        mockMvc.perform(get("/mealdb/1")
